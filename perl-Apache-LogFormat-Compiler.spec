...
cp %{_builddir}/Apache-LogFormat-Compiler-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Apache-LogFormat-Compiler/2c39d05eff7565e4bd58a83e6173e2419ef30aeb || :
if test -f Makefile.PL; then
